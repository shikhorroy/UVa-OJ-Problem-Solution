...
#define NUM 15
int charmichaelNum[] = {561, 1105, 1729, 2465, 2821, 6601, 8911, 10585, 15841, 29341, 41041, 46657, 52633, 62745, 63973, 75361};

bool check(int n)
{
    for(int i = 0; i < NUM; i++)
        if(n == charmichaelNum[i]) return true;
    return false;
}
int main()
{
...
//    sieve_method();
    ...
    {
        if(!n) return 0;
        if(check(n)) pf("The number %d is a Carmichael number.\n", n);
        else pf("%d is normal.\n", n);
    }
//    cl = clock() - cl;
